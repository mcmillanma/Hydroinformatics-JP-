...
#look at yellow to see where depressions are
```
...
```{r}
#sca= specifc contributin area
wbt_d_inf_flow_accumulation("McDonaldHollowDEM/bmstationdem_filled_breached.tif",
                         "McDonaldHollowDEM/DinfFAsca.tif",
                         out_type = "Specific Contributing Area")

wbt_slope("McDonaldHollowDEM/bmstationdem_filled_breached.tif", output = "McDonaldHollowDEM/demslope.tif", unit = "degrees" )
...
```{r}
twidvals <-  raster::extract(x = twid, #raster 
                 y = pointsSP, #points
                 method = "simple")
